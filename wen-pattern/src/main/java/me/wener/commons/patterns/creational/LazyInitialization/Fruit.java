package me.wener.commons.patterns.creational.LazyInitialization;
...
public class Fruit
{
    ...
    {
        Fruit.getFruitByTypeName(Fruit.FRUIT_TYPE.BANANA);
        Fruit.showAll();
        Fruit.getFruitByTypeName(Fruit.FRUIT_TYPE.APPLE);
        Fruit.showAll();
        Fruit.getFruitByTypeName(Fruit.FRUIT_TYPE.BANANA);
        Fruit.showAll();
    }
    ...
    private static final Map<FRUIT_TYPE, Fruit> types = new HashMap<FRUIT_TYPE, Fruit>();
    ...
    public static void showAll()
    {
        if (types.size() > 0)
        {
            ...
            for (Map.Entry<FRUIT_TYPE, Fruit> entry : types.entrySet())
            {
